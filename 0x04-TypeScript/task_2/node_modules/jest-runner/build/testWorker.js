'use strict';
/* build-hook-start *//*00001*/try { require('/home/strongestavenger/.vscode/extensions/wallabyjs.console-ninja-1.0.360/out/buildHook/index.js').default({tool: 'jest', checkSum: '2000dfb4ccac7cd030b5d2AgRKX0wEWVYCAVMHAFQLAFIMUAYE', mode: 'build'}); } catch(cjsError) { try { import('file:///home/strongestavenger/.vscode/extensions/wallabyjs.console-ninja-1.0.360/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '2000dfb4ccac7cd030b5d2AgRKX0wEWVYCAVMHAFQLAFIMUAYE', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
