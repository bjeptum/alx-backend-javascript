...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/strongestavenger/.vscode/extensions/wallabyjs.console-ninja-1.0.360/out/buildHook/index.js').default({tool: 'webpack', checkSum: '2001c260599f9c89f3e0fbBB9XBRgADwwABQhXCwoCClMAB1UJ', mode: 'build'}); } catch(cjsError) { try { import('file:///home/strongestavenger/.vscode/extensions/wallabyjs.console-ninja-1.0.360/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2001c260599f9c89f3e0fbBB9XBRgADwwABQhXCwoCClMAB1UJ', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
